...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/project/2026winter/ldy1118/VISION-Instance-Seg/results/merged_datasets/_exp2_3cls_val/annotations.json',
        backend_args=None,
        data_prefix=dict(
            img=
            '/project/2026winter/ldy1118/VISION-Instance-Seg/results/merged_datasets/_exp2_3cls_val/images'
        ),
        data_root='data/coco/',
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/project/2026winter/ldy1118/VISION-Instance-Seg/results/merged_datasets/exp2/cond4_8x/Exp2_3cls/seed42/annotations.json',
        backend_args=None,
        data_prefix=dict(
            img=
            '/project/2026winter/ldy1118/VISION-Instance-Seg/results/merged_datasets/exp2/cond4_8x/Exp2_3cls/seed42/images'
        ),
        data_root='data/coco/',
...
work_dir = '/project/2026winter/ldy1118/VISION-Instance-Seg/results/training/exp2/cond4_8x/Exp2_3cls/rtmdet_ins/seed42'
